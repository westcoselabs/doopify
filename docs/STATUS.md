...
- session hash rollout uses the additive `20260713_session_hash_compatibility` migration; see `docs/SESSION_TOKEN_MIGRATION_RUNBOOK.md` for the mandatory migration-history decision before deployment
